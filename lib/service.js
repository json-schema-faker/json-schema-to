...
class Service {
  ...
  static bundle(pkgInfo, models) {
    ...
    return {
      ...
      get queries() {
        return jst.gqlQueries({ pkg, refs }, { enums }, defns);
      },
      get graphql() {
  ...
  static merge(pkgInfo, models) {
    ...
    return {
      ...
      get queries() {
        return jst.gqlQueries(resource, options, defns);
      },
      get graphql() {
  ...
  static load(directory, schemas, refs) {
    ...
    return Promise.resolve()
      ...
      .then(fixedRefs => Promise.all(bundle.map(cb => cb(fixedRefs))).then(x => fixedRefs.concat(x)));
  }
  ...
  get queries() {
    return jst.gqlQueries(this._resource, this.options, this.defns);
  }
